...
public class ADD_Customer3 extends JFrame implements ActionListener{
    ...
    ADD_Customer3(){
        ...
        setLocation(10,10);
        setResizable(false);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("trainer1.jpg"));
    ...
    public void actionPerformed(ActionEvent e){
        try{
            ...
            if(e.getSource()==bt4){
                Connection_Class obj1=new Connection_Class();
                String q1="select * from add_trainer where catogery='Personal'";
                ResultSet rest1=obj1.stm.executeQuery(q1);
                while(rest1.next()){
                    ch5.add(rest1.getString("name"));
                }
            ...
            if(e.getSource()==bt1){
                ...
                String q="insert into add_customer values('"+recipt_no+"','"+name+"','"+fname+"','"+email+"','"+address+"','"+cont+"','"+minag+"','"+gender+"','"+height+"','"+weight+"')";
