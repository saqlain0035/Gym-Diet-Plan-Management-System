 ...
 * @author Hp
 */
public class SignnIn3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gym_management/images/1.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String cnf_pass =jPasswordField2.getText();
        ...
        String query1= "insert into admin_data (name, email, phone, username, password,cnf_pass) VALUES('"+name+"','"+email+"',"+phone+",'"+username+"','"+password+"','"+cnf_pass+"')";
//        String query1="insert into admin_data(`username`, `password`) VALUES ('"+username+"','"+password+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignnIn3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
