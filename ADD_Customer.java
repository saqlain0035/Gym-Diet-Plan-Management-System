...
public class ADD_Customer extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String receipt=jTextField6.getText();
        String payments=(String)jComboBox1.getSelectedItem().toString();
        String gender=(String)jComboBox4.getSelectedItem().toString();
        String height=jTextField8.getText();
        String weight=jTextField9.getText();
        String remarks=jTextField10.getText();
        String m_category=(String)jComboBox2.getSelectedItem().toString();
        String trainer=(String)jComboBox3.getSelectedItem().toString();
        ...
        String querry1= "INSERT INTO add_customer(name,f_name, email, address, contact, receipt ,payments, gender, height, weight, remarks, m_category, trainer) VALUES ('"+name+"','"+f_name+"', '"+email+"', '"+address+"', '"+contact+"', '"+receipt+"', '"+payments+"', '"+gender+"', '"+height+"', '"+weight+"', '"+remarks+"', '"+m_category+"', '"+trainer+"')";
        obj.stm.executeUpdate(querry1);
